...
const IndexPage = () => (
  <Layout>
    ...
    <Hero heroImage="hero-image" heroText="Human Trafficking includes the use of force, fraud, or coercian to obtain some type of Labor or Commercial Sex Act." heroCitation="Homeland Security"/>
